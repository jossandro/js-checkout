...
// From here the code is just in case you want to try bringing data from a "backend" using micro service / rest api to load the products available and price rules
